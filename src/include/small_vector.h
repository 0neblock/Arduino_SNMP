...
namespace sbo {
    ...
    struct small_buffer_vector_allocator {
        alignas(alignof(T)) uint8_t m_smallBuffer[MaxSize * sizeof(T)];
        ...
        constexpr small_buffer_vector_allocator() = default;
        template<class U>
        constexpr small_buffer_vector_allocator(const small_buffer_vector_allocator<U, MaxSize, NonReboundT> &) {}
        ...
        small_buffer_vector_allocator(const small_buffer_vector_allocator &other) : m_smallBufferUsed(other.m_smallBufferUsed) {}
        small_buffer_vector_allocator &operator=(const small_buffer_vector_allocator &other) const {
            m_smallBufferUsed = other.m_smallBufferUsed;
            return *this;
        }
        small_buffer_vector_allocator(small_buffer_vector_allocator &&) {}
        small_buffer_vector_allocator &operator=(const small_buffer_vector_allocator &&) { return *this; }
    ...
    class small_vector : public std::vector<T, small_buffer_vector_allocator<T, N>> {
      public:
        ...
        small_vector() { vectorT::reserve(N); }
