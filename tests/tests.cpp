...
static SNMPPacket *GenerateTestSNMPRequestPacket() {
    ...
    packet->varbindList.push_back(
            VarBind(std::make_shared<SortableOIDType>(".1.3.6.1.4.1.5.1"), std::make_shared<IntegerType>(42)));
    packet->varbindList.push_back(
            VarBind(std::make_shared<SortableOIDType>(".1.3.6.1.4.1.5.2"), std::make_shared<OctetType>("test 123")));
    packet->varbindList.push_back(
            VarBind(std::make_shared<SortableOIDType>(".1.3.6.1.4.1.52420.9999999"), std::make_shared<IntegerType>(0)));
    packet->varbindList.push_back(
            VarBind(std::make_shared<SortableOIDType>(".1.3.6.1.4.1.5.3"), std::make_shared<IntegerType>(-42)));
    packet->varbindList.push_back(
            VarBind(std::make_shared<SortableOIDType>(".1.3.6.1.4.1.5.4"), std::make_shared<IntegerType>(-420000)));
...
TEST_CASE("Test SetRequestPDU", "[snmp]") {
    ...
    requestPacket->varbindList.push_back(VarBind(std::make_shared<SortableOIDType>(".1.3.6.1.4.1.5.7"),
                                                 std::make_shared<OpaqueType>(setOpaqueBuf, 5)));
